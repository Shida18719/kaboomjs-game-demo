...
var mo = o((s = {}) => {
  ...
  class le {
    ...
    static fromURL(n, r = {}) {
      return Qe(n).then(i => le.fromImage(i, r));
    }
  }
  o(le, "SpriteData");
  class ge {
  ...
  function on(e, n, r, i, u = {}) {
    return B.bitmapFonts.add(e, Qe(n).then(l => de(Y.fromImage(l, u), r, i, u.chars ?? Br)));
  }
  o(on, "loadBitmapFont");
  ...
  function He(e, n, r = {
    ...
    return Array.isArray(n) ? n.some(i => typeof i == "string") ? B.sprites.add(e, Promise.all(n.map(i => typeof i == "string" ? Qe(i) : Promise.resolve(i))).then(i => Tt(i, r))) : B.sprites.addLoaded(e, Tt(n, r)) : typeof n == "string" ? B.sprites.add(e, le.from(n, r)) : B.sprites.addLoaded(e, le.fromImage(n, r));
  }
  o(He, "loadSprite");
  function an(e, n) {
    return B.sprites.add(e, new Promise(async r => {
      let i = typeof n == "string" ? await Je(n) : n,
        u = await Promise.all(i.frames.map(Qe)),
  ...
  function un(e, n, r) {
    ...
    let i = typeof r == "string" ? Je(r) : Promise.resolve(r);
  ...
  function Be(e, n, r, i = w.defTex, u = w.defShader, l = {}) {
    ...
    let m = w.fixed || r ? w.transform : T.cam.transform.mult(w.transform);
    for (let f of e) {
  ...
  function mt() {
    ...
    }), w.drawCalls = 0, w.fixed = !1, w.transformStack.length = 0, w.transform = new Q();
  }
  o(mt, "frameStart");
  function gn(e, n) {
  ...
  function qn(e) {
    ...
    if (!(n.length < 2)) if (e.radius && n.length >= 3) {
      ...
      p1: n[r],
      p2: n[r + 1]
    })), e.join !== "none" && Ze(Object.assign({}, e, {
      pos: n[r],
      radius: e.width / 2
    }));
  }
...
`) D += l + m, $.push({
  ...
  o(Lt, "mousePos"), et.error = e => {
    if (e.error) Cn(e.error);else {
      if (e.message === "Script error.") return;
      Cn(new Error(e.message));
    }
  }, et.unhandledrejection = e => Cn(e.reason);
  for (let e in et) window.addEventListener(e, et[e]);
  let se = {
    inspect: !1,
    timeScale: 1,
    showLog: !0,
    ...
    let n = new Map(),
      ...
      l = {
        ...
        draw() {
          ...
          let a = w.fixed;
          this.fixed && (w.fixed = !0), re(), b(this.pos), C(this.scale), L(this.angle), this.trigger("draw"), this.children.sort((m, f) => (m.z ?? 0) - (f.z ?? 0)).forEach(m => m.draw()), j(), w.fixed = a;
        },
        drawInspect() {
  ...
  function ir(e, ...n) {
    let r = e(Ke),
      i;
    typeof r == "function" ? i = r(...n)(Ke) : i = r;
    for (let u in i) Ke[u] = i[u], s.global !== !1 && (window[u] = i[u]);
    return Ke;
  }
  o(ir, "plug");
  function _t() {
      ...
      Ue = {
        ...
        getTilePath(y, R, P = {}) {
          ...
          for (me.set(G, 0); X.length !== 0;) {
            ...
            for (let Ye of On) {
              let Pn = (me.get(Le) || 0) + H(Le, Ye) + q(Ye, k);
              (!me.has(Ye) || Pn < me.get(Ye)) && (me.set(Ye, Pn), X.insert({
                cost: Pn,
                node: Ye
              }), oe.set(Ye, Le));
            }
...
`),
  ...
  function hi() {
    T.events.onOnce("frameEnd", () => {
      U.quit();
      for (let n in et) window.removeEventListener(n, et[n]);
  ...
  if (s.plugins && s.plugins.forEach(ir), s.global !== !1) for (let e in Ke) window[e] = Ke[e];
...
},{}]},{},["../../home/gitpod/.nvm/versions/node/v20.5.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/script.js"], null)
